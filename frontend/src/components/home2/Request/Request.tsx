      ...
      <div className="w-full xl:w-[65%] xl:pl-8 mt-[6px]">
        <div className="relative xl:pl-12">
          ...
          <button
            ...
            className="absolute xl:mr-[9px] right-0 top-0 bottom-0 w-[113px] bg-[#FF64AE] text-white rounded-r-[25px] hover:bg-[#FF64AE] focus:outline-none focus:ring-2 focus:ring-[#FF64AE] focus:ring-offset-2 flex items-center justify-center"
          >
            <div >
              <PhoneIcon />
            </div>
