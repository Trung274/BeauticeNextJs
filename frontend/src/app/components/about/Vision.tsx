    ...
    <div className="flex flex-wrap w-full justify-between items-start">
        ...
        <div className="flex flex-col gap-y-5 w-full md:w-[45%]">
            <div className="flex flex-col gap-y-5">
                <div className="text-xs font-semibold text-[#FF64AE]">Our Vision</div>
                <div className="text-3xl text-[#091156] font-semibold">Be the best and go <br /> international</div>
