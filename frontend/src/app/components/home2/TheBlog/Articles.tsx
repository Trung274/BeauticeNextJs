...
const ArticleCard: React.FC<ArticleCardProps> = ({ article }) => (
  <div className="w-full xl:w-[347px] h-[543px] bg-white rounded-[25px] overflow-hidden shadow-lg flex flex-col">
    ...
    <div className="flex flex-col ml-[38px] pt-[57px] ">
...
const ArticlePost: React.FC = () => (
  <div className="grid grid-cols-1 xl:grid-cols-3 xl:gap-x-12 gap-8">
