...
const ContactCard: React.FC<ContactCardProps> = ({ info }) => (
  <div className="flex justify-center">
    <div className="max-w-sm bg-white rounded-3xl overflow-hidden p-6 transition-all duration-300 hover:w-[424px] hover:h-[402px] hover:drop-shadow-[0_8px_30px_rgba(0,0,0,0.05)]">
