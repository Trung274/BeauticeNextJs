...
const InputField = ({ ...props }) => (
  <input
    {...props}
    className="w-full h-[61px] border border-[#D9DDFE] rounded-[15px] px-4 text-base text-gray-500 placeholder:text-sm placeholder:text-gray-400 placeholder:tracking-widest placeholder:relative placeholder:top-0 placeholder:left-1.5 focus:outline-none focus:ring-2 focus:ring-[#FF64AE] focus:border-transparent"
  />
);
